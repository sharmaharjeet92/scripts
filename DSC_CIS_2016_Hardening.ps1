...
Configuration CIS_WindowsServer2016_v100_MS_lvl1 {
    ...
    Node $NodeName {
        ...
        SecurityOption AccountSecurityOptions {
            ...
            Interactive_logon_Message_text_for_users_attempting_to_log_on = 'This system is restricted to authorized users of Traveloka. Individuals who attempt unauthorized access will be prosecuted as per Traveloka Policy.' # 2.3.7.4 (L1) Configure 'Interactive logon: Message text for users attempting to log on'
            Interactive_logon_Message_title_for_users_attempting_to_log_on = 'Legal  Notice:By Clicking OK indicate your acceptance of this information' # 2.3.7.5 (L1) Configure 'Interactive logon: Message title for users attempting to log on'
